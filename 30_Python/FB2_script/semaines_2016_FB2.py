...
nom_figure_moyenne = 'la courbe moyenne de 2016 FB2 {:}'.format(time.strftime("%Y-%m-%d-%H:%M"))
...
#==============================================================================
def moyenne_norm():
    for data in [data01FB2, data10FB2, data11FB2, data14FB2, data21FB2, data22FB2, data28FB2]:        
...
def semaine_plot():
    ...
    ax1.plot(data01FB2.index, data01FB2.mean_essai_sem, 'o-', c = 'r', label = " moyenne des essais semaine 01")
    ax1.plot(data10FB2.index, data10FB2.mean_essai_sem, 'o-', c = 'hotpink', label = " moyenne des essais semaine 10")
    ax1.plot(data11FB2.index, data11FB2.mean_essai_sem, 'o-', c = 'y', label = " moyenne des essais semaine 11")
    ax1.plot(data14FB2.index, data14FB2.mean_essai_sem, 'o-', c = 'm', label = " moyenne des essais semaine 14")
    ax1.plot(data21FB2.index, data21FB2.mean_essai_sem, 'o-', c = 'b', label = " moyenne des essais semaine 21")
    ax1.plot(data22FB2.index, data22FB2.mean_essai_sem, 'o-', c = 'g', label = " moyenne des essais semaine 22")
    ...
    #ax1.set_xlim(-1, 180)
    #ax1.set_ylim(0,60)
    plt.title("Courbes moyenne Fluo des Semaines 1-22 2016 FB2")
    plt.legend()
    plt.show()
    plt.savefig("Courbes2 moyenne Fluo des Semaines 1-22 2016 FB2") 
    return;
...
def semaine_norm_plot():
    fig1, ax1 = plt.subplots(1, 1, figsize =(18,10))
    ax1.plot(data01FB2.index, data01FB2.moyenne_norm_par_essai, 'o-', c = 'r', label = " moyenne des essais semaine 01")
    ax1.plot(data10FB2.index, data10FB2.moyenne_norm_par_essai, 'o-', c = 'g', label = " moyenne des essais semaine 10")
    ax1.plot(data11FB2.index, data11FB2.moyenne_norm_par_essai, 'o-', c = 'y', label = " moyenne des essais semaine 11")
    ax1.plot(data14FB2.index, data14FB2.moyenne_norm_par_essai, 'o-', c = 'm', label = " moyenne des essais semaine 14")
    ax1.plot(data21FB2.index, data21FB2.moyenne_norm_par_essai, 'o-', c = 'b', label = " moyenne des essais semaine 21")
    ax1.plot(data22FB2.index, data22FB2.moyenne_norm_par_essai, 'o-', c = 'pink', label = " moyenne des essais semaine 22")   
    plt.xlabel("Heure d'essai ")
    plt.ylabel("Moyenne_Fluo")
    #ax1.set_xlim(-1, 180)
    #ax1.set_ylim(0, 2.5)
    ...
    plt.legend()
    plt.show()
    plt.savefig("Courbes des Moyennes Normalisees des Semaines 1-22 2016 FB2") 
    return;
