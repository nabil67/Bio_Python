...
nom_figure_moyenne = 'la courbe moyenne de la semaine 02_2016  FB2_logE {:}'.format(time.strftime("%Y-%m-%d-%H:%M"))
nom_figure_entropie = 'la courbe entropie de la semaine 02_2016 FB2_logE {:}'.format(time.strftime("%Y-%m-%d-%H:%M"))
...
if __name__ == "__main__": 
    ...
    print("Nombre d'essayes:", df.num_essaye[len(df) - 1])
