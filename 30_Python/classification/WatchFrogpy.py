...
#==============================================================================
def en_journee(ls, cs):             # ls : levée de soleil
...
#==============================================================================
"""----------------------  Date relatif de l'obs--------------------------"""      
#==============================================================================
def Date_relatif(df):
    date_relatif = [0]
    for i in xrange(1,len(df)): 
        diff = df.index[i] - df.index[0]
        date_relatif.append(diff.total_seconds())
    df["date_relatif"] = date_relatif
    return df
#==============================================================================
