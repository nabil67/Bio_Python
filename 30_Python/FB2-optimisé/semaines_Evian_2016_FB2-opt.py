...
global data01FB2opt, data10FB2opt, data11FB2, data14FB2opt, data21FB2opt, data22FB2opt;

#========================================================================================
""" des données sont enregistrées dans le fichier FB2-optimisé/Evian_FB2_opt.spydata """
#========================================================================================



strtime = time.strftime("%Y-%m-%d__%H-%M")

nom_figure_moyenne = file_name = 'U:/Stagiaires/Nabil.BELAHRACH/Donnees/40_figures/obs_semaines/FB_evian_moyenne_TTsemaines'
nom_figure_moyenne = 'la courbe moyenne de 2016 FB2-opt {:}'.format(strtime)
...
#=========================================================================================
def moyenne_norm():
    for data in [data01FB2opt, data10FB2opt, data11FB2, data14FB2opt, data21FB2opt, data22FB2opt ]:        
...
def semaine_plot():
    ...
    ax1.plot(data01FB2opt.index, data01FB2opt.mean_essai_sem, 'o-', c = 'r', label = " moyenne des essais semaine 01")
    ax1.plot(data10FB2opt.index, data10FB2opt.mean_essai_sem, 'o-', c = 'blue', label = " moyenne des essais semaine 10")
    ax1.plot(data11FB2.index, data11FB2.mean_essai_sem, 'o-', c = 'y', label = " moyenne des essais semaine 11")
    ax1.plot(data14FB2opt.index, data14FB2opt.mean_essai_sem, 'o-', c = 'm', label = " moyenne des essais semaine 14")
    #ax1.plot(data21FB2opt.index, data21FB2opt.mean_essai_sem, 'o-', c = 'b', label = " moyenne des essais semaine 21")
    ax1.plot(data22FB2opt.index, data22FB2opt.mean_essai_sem, 'o-', c = 'g', label = " moyenne des essais semaine 22")
    #ax1.plot(data28FB2.index, data28FB2.mean_essai_sem, 'o-', c = 'black', label = " moyenne des essais semaine 28")
    #plt.axhline(data.mean_essai_sem.mean(),c='black', label='Moyenne totale', linestyle="--")
    #plt.axhline(data.mean_essai_sem.mean() + 3*data.mean_essai_sem.std() , c='r', label='LCS', linestyle='-')
    #plt.axhline(data.mean_essai_sem.mean() - 3*data.mean_essai_sem.std() , c='r', label='LCI', linestyle='-')
    plt.xlabel("Heure d'essai")
    plt.ylabel("Moyenne_Fluo")
    #ax1.set_xlim(-1, 180)
    ax1.set_ylim(0,60)
    plt.title("Courbes moyenne Fluo des Semaines 1-22 2016 FB2opt")
    plt.legend()
    plt.show()
    plt.savefig("Courbes2 moyenne Fluo des Semaines 1-22 2016 FB2opt") 
    return;
...
def semaine_norm_plot():
    fig1, ax1 = plt.subplots(1, 1, figsize =(18,10))
    ax1.plot(data01FB2opt.index, data01FB2opt.moyenne_norm_par_essai, 'o-', c = 'r', label = " moyenne des essais semaine 01")
    ax1.plot(data10FB2opt.index, data10FB2opt.moyenne_norm_par_essai, 'o-', c = 'g', label = " moyenne des essais semaine 10")
    ax1.plot(data11FB2.index, data11FB2.moyenne_norm_par_essai, 'o-', c = 'y', label = " moyenne des essais semaine 11")
    ax1.plot(data14FB2opt.index, data14FB2opt.moyenne_norm_par_essai, 'o-', c = 'm', label = " moyenne des essais semaine 14")
    ax1.plot(data21FB2opt.index, data21FB2opt.moyenne_norm_par_essai, 'o-', c = 'b', label = " moyenne des essais semaine 21")
    ax1.plot(data22FB2opt.index, data22FB2opt.moyenne_norm_par_essai, 'o-', c = 'pink', label = " moyenne des essais semaine 22")   
    plt.xlabel("Heure d'essai ")
    plt.ylabel("Moyenne_Fluo")
    #ax1.set_xlim(-1, 180)
    #ax1.set_ylim(0, 60)
    plt.title("Courbes des Moyennes Normalisees des Semaines 1-22 2016 FB2opt")
    plt.legend()
    plt.show()
    plt.savefig("Courbes des Moyennes Normalisees des Semaines 1-22 2016 FB2opt") 
    return;


#==============================================================================
"""--------------- conca && discrétisation par interval------ obsolète ! ------------ """
#==============================================================================

def data_interval_1h_seuil():
    data = pd.concat([ data01FB2, data10FB2, data11FB2, data14FB2, data21FB2, data22FB2] , axis=0, ignore_index=True)
...
def data_interval_plot():
    ...
    plt.title("Moyenne ponderee par 1h-intervalle  2016_FB2")
    plt.show()
    plt.savefig("Moyenne ponderee par 1h-intervalle 1h 2016_FB2 + mean average")
    return; 
