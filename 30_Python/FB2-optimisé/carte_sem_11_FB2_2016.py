...
nom_figure_moyenne = 'la courbe moyenne de la semaine 11_2016  FB2 {:}'.format(strtime)
nom_figure_entropie = 'la courbe entropie de la semaine 11_2016 FB2 {:}'.format(strtime)
