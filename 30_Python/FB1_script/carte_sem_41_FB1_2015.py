...
#df1 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/41_2015/FB1/ErrorLog0.csv",             
...
df  = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/41_2015_T3/FB1/Results_opt.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])  

#df3 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/41_2015/FB1/Results_20151106-0932.csv",
#                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
#                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])                  
#                                    

#df4 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/41_2015_T3/FB1/Results_20151125-0902.csv",
#                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
#                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])    
...
nom_figure_moyenne = 'la courbe moyenne de la semaine 41_2015   {:}'.format(FB) +' {:}'.format(timestr) 
nom_figure_entropie = 'la courbe entropie de la semaine 41_2015   {:}'.format(FB) +' {:}'.format(timestr) 
...
if __name__ == "__main__": 
    ...
    date_to_hour(df)   
    data41 = df_semaine(df, file_name, semaine, FB)
    data41 = convert_to_hours(data41)  
