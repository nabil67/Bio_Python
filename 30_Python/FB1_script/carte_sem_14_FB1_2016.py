...
df1 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/14_2016/FB1/ErrorLog.csv",             
...
df2 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/14_2016/FB1/Results_20160405-1502.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])  

df3 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/14_2016/FB1/Results_20160405-1502ET.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])                  
                  # bon                  
#
...
nom_figure_moyenne = 'la courbe moyenne de la semaine 14_2016 ErrLog  FB1 {:}'.format(timestr)
nom_figure_entropie = 'la courbe entropie de la semaine 14_2016 ErrLog FB1  {:}'.format(timestr)
...
if __name__ == "__main__": 
    ...
    date_to_hour(df)   
    data14 = df_semaine(df, file_name, semaine, FB)
    data14Evian = convert_to_hours(data14) 
    del data14
    #m14 = en_journee(df,ls,cs)
