...
#    #for dfm in [data01, data10, data11, data14, data21, data22]:
#        data22 = data22.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})       # Rename
#        data21 = data21.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})
#        data01 = data01.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})
#        data10 = data10.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})
#        data11 = data11.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})
#        data14 = data14.rename(columns = {'mean_essaye_sem':'mean_essai_sem'})
#        return;
...
#==============================================================================
def moyenne_norm():
    for data in [data01, data10, data11, data14, data21, data22]:        
...
def semaine_plot():
    ...
    ax1.plot(data10.index, data10.mean_essai_sem, 'o-', c = 'hotpink', label = " moyenne des essais semaine 10")
    ...
    ax1.plot(data22.index, data22.mean_essai_sem, 'o-', c = 'g', label = " moyenne des essais semaine 22")
    plt.axhline(dataEvianFB1.mean_essai_sem.mean(),c='black', label='Moyenne totale', linestyle="--")
    ...
    plt.legend()
    plt.show()
    plt.savefig(nom_figure_moyenne +'/'+ "Courbes2 moyenne Fluo des Semaines 1-22 2016 FB1") 
...
def semaine_norm_plot():
    ...
    plt.legend()
    plt.show()
    plt.savefig(nom_figure_moyenne +'/'+ "Courbes des Moyennes Normalisees des Semaines 1-22 2016 FB1_1") 
...
def data_hdf_stock():
    ...
    for data in [data01, data10, data21, data14, data21, data22]:
        stock.append(data)
...
#==============================================================================
"""-----------comparaison des variance Evian FB1 vs FB2---------------------"""
#==============================================================================


dataEvianFB2.to_csv('FB2.csv', sep=";")
dataEvianFB1.to_csv('FB1.csv', sep=";")

dataRevian.to_csv('dataRevian.csv', sep=";")
