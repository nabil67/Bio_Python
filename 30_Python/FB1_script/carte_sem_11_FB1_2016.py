...
df2 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/11_2016/FB1/Results_20160315-1348.csv",
...
nom_figure_moyenne = 'la courbe moyenne de la semaine 11_2016  FB1 {:}'.format(timestr)
nom_figure_entropie = 'la courbe entropie de la semaine 11_2016 FB1 {:}'.format(timestr)

file_name = 'U:/Stagiaires/Nabil.BELAHRACH/Donnees/40_figures/obs_semaines/sem11_2016/'
try:
    os.mkdir(file_name) 
except :
    pass
...
if __name__ == "__main__": 
    ...
    df = essai_nbr( df )     
    df11 = moyenne_par_essai(df)    
    moyenne_plot(df11, file_name, nom_figure_moyenne)
    ...
    date_to_hour(df11)   
    data11 = df_semaine(df, file_name, semaine, FB)
    data11Evian = convert_to_hours(data11) 
#    m11 = en_journee(df,ls,cs)
