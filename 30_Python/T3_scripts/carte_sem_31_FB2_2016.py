...
df2 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/31_2016_T3/FB2/Results_20160802-0901.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False,
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])  

df3 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/31_2016_T3/FB2/Results_20160804-0817.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False,
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])                  
                                    
df4 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/31_2016_T3/FB2/Results_20160805-0812.csv",
                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False,
                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient']) 
#                  
...
df = pd.concat([df4, df2, df3] , axis=0, ignore_index=True)  
...
if __name__ == "__main__": 
    ...
    date_to_hour(df)   
    data31_2016FB2 = df_semaine(df, file_name, semaine, FB)
