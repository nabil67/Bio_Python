...
#df4 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/46_2015_T3/FB1/Results20150404-0756.csv",
#                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
#                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient'])    
#                  
#df5 = pd.read_csv("U:/Stagiaires/Nabil.BELAHRACH/Donnees/30_Python/fichiers_csv/46_2015_T3/FB1/Results20150404-0756ET.csv",
#                  usecols=[1,4,5,8,9,10,11], sep = ";", header = False, 
#                  names = ['nom','moyenne','ecart-type','solidite','entropie','smoothness','mm_gradient']) 
...
if __name__ == "__main__": 
    ...
    date_to_hour(df)   
#    data46_2015FB1 = df_semaine(df, file_name, semaine, FB)
#    data46FB1_2015_T3 = convert_to_hours(data46_2015FB1)         
#    del data46_2015FB1                         
    #num_tetard(df)
