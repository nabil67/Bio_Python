...
def moyenne_norm(df):
    moyenne_norm_par_essai = df.mean_essai_sem / df.mean_essai_sem[0]
    df["moyenne_norm_par_essai"] = moyenne_norm_par_essai
    return df;
...
def entropie_plot(df, file_name, nom_figure_entropie):
    ...
    return;
#==============================================================================
"""-------------------------  changement de repère temporelle-------------- """
#==============================================================================
def date_to_hour(df):                           
    ...
    return;   
#==============================================================================
"""------------------------- sortie d = { 'hours_debut' ,'mean_essai '} """
#==============================================================================    
